...
$(function () {
    ...
    if (userCreatedElement.length !== 0) {
        Swal.fire({
            ...
            type: 'success',
            html: 'Your account has been created. The admin will assign your role as soon as possible. If you have questions or problems, please send the ' +
                ' admin an email through the <strong class="font-weight-bold">Contact Admin</strong> link.',
    ...
    if (userRegisteredElement.length !== 0) {
        Swal.fire({
            ...
            type: 'success',
            html: 'Thank you for registering. You will need to confirm your email before logging in. Please check your email ' +
