...
namespace HoaWebAPI.AutoMapperProfiles
{
    public class MeetingMinuteProfile : Profile
    {
        ...
        {
            CreateMap<MeetingMinute, MeetingMinuteViewDto>()
            ...
            CreateMap<MeetingMinuteInputDto, MeetingMinute>()
                .ForMember(dest => dest.Created, opt => opt.MapFrom(src => DateTime.Now))
                .ForMember(dest => dest.Id, opt => opt.Ignore())
                .ForMember(dest => dest.UserId, opt => opt.Ignore())
                .ForMember(dest => dest.CreatedBy, opt => opt.Ignore())
                .ForMember(dest => dest.BoardMeetingId, opt => opt.Ignore())
                .ForMember(dest => dest.Meeting, opt => opt.Ignore());

            CreateMap<MeetingMinuteUpdateDto, MeetingMinute>()
                .ForMember(dest => dest.Id, opt => opt.Ignore())
            ...
            CreateMap<MeetingMinute, MeetingMinuteUpdateDto>();
        }
    }
}
